...
let ancestors = async (id) => {
    ...
    let updateStage = async (ancestor, parent, n, a) => {
        ...
        if (a == n) {
            ...
            if (parent.children[1].children !== undefined && parent.children[1].children.length == 2) {
                ...
                if(
                    parent.children[1].children[1] !== undefined
                    ...
                    if (parent.current_stage == 2) {
                        ...
                        console.log(child1.children[1].children[1].children[1].children[1].attributes.username)
    ...
    if (members !== null) {
        for (let i = members.ancestors.length - 1; i >= 0; i--) {
            ...
            let stage1 = newStage((Number(1) + 1))
            let stage2 = newStage((Number(2) + 1))
            let stage3 = newStage((Number(3) + 1))
            let stage4 = newStage((Number(4) + 1))
            let stage5 = newStage((Number(5) + 1))
            console.log(stage1, stage2, stage3, stage4, stage5)
